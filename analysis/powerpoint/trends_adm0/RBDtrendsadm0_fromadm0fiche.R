...
#create text of current period
current_period <- "Current: September-December"
projected_period <- "Projected: June-August"
...
data_filtered_rbd$reference_label <- fct_relevel(data_filtered_rbd$reference_label,  "Current: September-December", "Projected: June-August",  "Current: January-May")


#phase5
phase5_rbd <- data_filtered %>% group_by(reference_label, reference_year) %>% 
...
plot_rbd_35 <- sum_phase_rbd_perc %>%  ggplot(aes(x = reference_year, y = phase35)) +geom_col(position = "dodge",fill = "#4E84C4", width = .75) +facet_grid(. ~ reference_label) +theme_vamgraphs() +labs(title = "Trends of the Number of Food Insecure (phase 3 - 5) by Season", subtitle = "Includes all RBD Countries", caption = "") 
...
#Entire region
#number phase3-5 by season
plot_rbd_phase5 <- phase5_rbd %>%  ggplot(aes(x = reference_year, y = phase5)) +geom_col(position = "dodge",fill = "#5e0803", width = .75) +facet_grid(. ~ reference_label) +theme_vamgraphs() +labs(title = "Trends of the Number of Phase 5 by Season", subtitle = "Includes all RBD Countries", caption = "") 
...
plot_sahel_proj <- data_filtered_country_perc  %>% filter(adm0_name %in% sahelplus & reference_label == "Projected: June-August")  %>%
  ggplot(aes(x = reference_year, y = phase35)) +geom_col(position = "dodge",fill = "#4E84C4", width = .75) +facet_grid(. ~ adm0_name) +theme_vamgraphs() +labs(title = "Trends of the Number of Food Insecure (phase3 to phase5)", subtitle = "June - August, 2017 - 2022: Sahel 6 & CMR/CAF/NGA", caption = "") 
...
plot_sahel_janmay <- data_filtered_country_perc %>% filter(adm0_name %in% sahelplus & reference_label == "Current: January-May")  %>%
  ggplot(aes(x = reference_year, y = phase35)) +geom_col(position = "dodge",fill = "#4E84C4", width = .75) +facet_grid(. ~ adm0_name) +theme_vamgraphs() +labs(title = "Trends of the Number of Food Insecure (phase3 to phase5)", subtitle = "January - May, 2017 - 2021: Sahel 6 & CMR/CAF/NGA", caption = "") 
...
plot_sahel_sepdec <- data_filtered_country_perc %>% filter(adm0_name %in% sahelplus & reference_label == "Current: September-December")  %>%
  ggplot(aes(x = reference_year, y = phase35)) +geom_col(position = "dodge",fill = "#4E84C4", width = .75) +facet_grid(. ~ adm0_name) +theme_vamgraphs() +labs(title = "Trends of the Number of Food Insecure (phase3 to phase5)", subtitle = "September - December, 2017 - 2021: Sahel 6 & CMR/CAF/NGA", caption = "") 
...
plot_coastal_proj <- data_filtered_country_perc %>% filter(adm0_name %in% coastal & reference_label == "Projected: June-August")  %>%
  ggplot(aes(x = reference_year, y = phase35)) +geom_col(position = "dodge",fill = "#4E84C4", width = .75) +facet_grid(. ~ adm0_name) +theme_vamgraphs() +labs(title = "Trends of the Number of Food Insecure (phase3 to phase5)", subtitle = "June - August, 2017 - 2022: Coastal Countries", caption = "") 
...
plot_coastal_janmay <- data_filtered_country_perc%>% filter(adm0_name %in% coastal & reference_label == "Current: January-May")  %>%
  ggplot(aes(x = reference_year, y = phase35)) +geom_col(position = "dodge",fill = "#4E84C4", width = .75) +facet_grid(. ~ adm0_name) +theme_vamgraphs() +labs(title = "Trends of the Number of Food Insecure (phase3 to phase5)", subtitle = "January - May, 2017 - 2021: Coastal Countries", caption = "") 
...
plot_coastal_sepdec <- data_filtered_country_perc %>% filter(adm0_name %in% coastal & reference_label == "Current: September-December")  %>%
  ggplot(aes(x = reference_year, y = phase35)) +geom_col(position = "dodge",fill = "#4E84C4", width = .75) +facet_grid(. ~ adm0_name) +theme_vamgraphs() +labs(title = "Trends of the Number of Food Insecure (phase3 to phase5)", subtitle = "September - December, 2017 - 2021: Coastal Countries", caption = "") 
...
ggplot(aes(x = reference_year, y = perc35)) +geom_col(position = "dodge",fill = "#4E84C4", width = .75) +facet_grid(. ~ adm0_name) +theme_vamgraphs() +labs(title = "Trends in the Percentage of Food Insecure (phase3 to phase5)", subtitle = "June - August, 2017 - 2022: Sahel 6 & CMR/CAF/NGA", caption = "") 
plot_sahel_proj_perc <- plot_sahel_proj_perc  +ylab("percent of people in phase3-5") +geom_text(aes(label = paste0(round(perc35),"%"), angle = 90, vjust = .5, hjust = -.1), size = 3) +scale_y_continuous(limits = c(0, 60)) 
...
ggplot(aes(x = reference_year, y = perc35)) +geom_col(position = "dodge",fill = "#4E84C4", width = .75) +facet_grid(. ~ adm0_name) +theme_vamgraphs() +labs(title = "Trends in the Percentage of Food Insecure (phase3 to phase5)", subtitle = "January - May, 2017 - 2021: Sahel 6 & CMR/CAF/NGA", caption = "") 
...
ggplot(aes(x = reference_year, y = perc35)) +geom_col(position = "dodge",fill = "#4E84C4", width = .75) +facet_grid(. ~ adm0_name) +theme_vamgraphs() +labs(title = "Trends in the Percentage of Food Insecure (phase3 to phase5)", subtitle = "September - December, 2017 - 2021: Sahel 6 & CMR/CAF/NGA", caption = "") 
plot_sahel_sepdec_perc <- plot_sahel_sepdec_perc +ylab("percent of people in phase3-5") +geom_text(aes(label = paste0(round(perc35),"%"), angle = 90, vjust = .5, hjust = -.1), size = 3) +scale_y_continuous(limits = c(0, 60)) 

# #Coastal 
# # % phase3-5 projected
plot_coastal_proj_perc <- data_filtered %>% filter(adm0_name %in% coastal & reference_label == "Projected: June-August")  %>%
ggplot(aes(x = reference_year, y = perc35)) +geom_col(position = "dodge",fill = "#4E84C4", width = .75) +facet_grid(. ~ adm0_name) +theme_vamgraphs() +labs(title = "Trends in the Percentage of Food Insecure (phase3 to phase5)", subtitle = "June - August, 2017 - 2022: Coastal countries", caption = "") 
plot_coastal_proj_perc  <- plot_coastal_proj_perc   +ylab("percent of people in phase3-5") +geom_text(aes(label = paste0(round(perc35),"%"), angle = 90, vjust = .5, hjust = -.1), size = 3) +scale_y_continuous(limits = c(0, 30)) 
 # % phase3-5 current - Jan-May
...
ggplot(aes(x = reference_year, y = perc35)) +geom_col(position = "dodge",fill = "#4E84C4", width = .75) +facet_grid(. ~ adm0_name) +theme_vamgraphs() +labs(title = "Trends in the Percentage of Food Insecure (phase3 to phase5)", subtitle = "September - December, 2017 - 2021: Coastal countries", caption = "") 
plot_coastal_sepdec_perc <- plot_coastal_sepdec_perc  +ylab("percent of people in phase3-5") +geom_text(aes(label = paste0(round(perc35),"%"), angle = 90, vjust = .5, hjust = -.1), size = 3) +scale_y_continuous(limits = c(0, 30)) 
