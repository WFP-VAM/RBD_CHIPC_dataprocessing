...
params: 
  country:
    ...
    value: Mali
    input: select
    choices: [Burkina Faso, Mali, Niger]
---
...
cadre_harmonise <- read_excel("C:/RBD_CHIPC_dataprocessing/data/processed/cadre_harmonise_caf_ipc.xlsx") %>% filter(adm0_name==params$country)
