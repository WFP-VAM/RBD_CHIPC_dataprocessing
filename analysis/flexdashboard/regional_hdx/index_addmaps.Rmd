...
Map of Current & Projected Outcomes (Food Consumption) {data-navmenu="Maps"}
=====================================
...
Map of Current & Projected Outcomes (Livelihoods) {data-navmenu="Maps"}
=====================================
...
Map of Current & Projected Outcomes (Nutrition) {data-navmenu="Maps"}
=====================================
...
Map of Current & Projected Outcomes (Mortality) {data-navmenu="Maps"}
=====================================
...
```{r}
datatable(cadre_harmonise_caf_ipc_projected,  extensions = 'Buttons', options = list(pageLength = 18, dom = "Bft",
    buttons = c('copy', 'csv', 'excel'))) %>%
  formatStyle(
    0,
    target = "row",
