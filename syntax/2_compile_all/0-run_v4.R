...
geo_dict <- read_sheet(url, sheet = "revised_distinct_dict", col_types = "c")
...
cadre_harmonise_caf_ipc <- cadre_harmonise_caf_ipc %>% 
...
#Create use period
cadre_harmonise_caf_ipc <- cadre_harmonise_caf_ipc %>% mutate(usethisperiod = case_when(
  ...
  period %in% c("Sep-Dec_2014_current_Sep-Dec_2014","Sep-Dec_2015_current_Sep-Dec_2015","Sep-Dec_2016_current_Sep-Dec_2016","Sep-Dec_2017_current_Sep-Dec_2017","Sep-Dec_2018_current_Sep-Dec_2018",
                "Sep-Dec_2019_current_Sep-Dec_2019","Sep-Dec_2020_current_Sep-Dec_2020") ~ "Y",
  #Central African Republic - jan/may current 2020 and 2021 are really september (projections) but fine for now
  period_country %in% c("CAF_Sep-Dec_2016_projected_Sep-Dec_2016","CAF_Jun-Aug_2016_current_Jun-Aug_2016","CAF_Jun-Aug_2016_projected_Sep-Dec_2016",
                        "CAF_Jan-May_2017_projected_Sep-Dec_2017","CAF_Sep-Dec_2018_projected_Jan-May_2019","CAF_Jun-Aug_2019_current_Jun-Aug_2019") ~ "Y", TRUE ~ "N"))
#get rid of not necessary variables
cadre_harmonise_caf_ipc <- cadre_harmonise_caf_ipc %>% dplyr::select(-UseThisPeriod, -status, -Comments,  -DataSource, -period_country, -period)
